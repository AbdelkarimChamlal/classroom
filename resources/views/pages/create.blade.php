...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-10">
            {!! Form::open(['action' => 'Pages@createCourse', 'method' => 'post']) !!}
                <div class="row">
                    <label class="col-4">Course name (  required  )  : </label>
                    <input type ="text" name="course_name" class="form-control col-8" placeholder=" 10th Grade Biology" />
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <input type ="text" name="course_descriptionHeading" class="form-control col-8" placeholder="for example : Welcome to 10th Grade Biology" />
                </div>
                <div class="row">
                    <label class="col-4">description (  optional  )  : </label>
                    <input type ="text" name="course_description" class="form-control col-8" placeholder=" We'll be learning about about the structure of living..." />
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <input type ="text" name="course_calendarId" class="form-control col-8" placeholder="123412341234" />
                </div>
                <div class="row">
