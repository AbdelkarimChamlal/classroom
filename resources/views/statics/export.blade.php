...
@section('content')
<h1>Export Statics</h1>
{!! Form::open(['action' => 'Statics@exportConfirmed', 'method' => 'post']) !!}
...
{!! Form::close() !!}
    ...
    @if (count($courses)>0)
    {!! Form::open(['action' => 'Statics@exportCourses', 'method' => 'post']) !!}
    ...
    <div class="export row">
        <div class="col-3 row">
            ...
            <input type ="radio" checked="checked" height="10px" name="exportChoice" value="classroom"  class="form-control col-1"/>
        </div>
        <div class="col-3 row">
            <h5 class="col-7">
                Drive Statics
            </h5>
            <input type ="radio" name="exportChoice" height="10px" value="drive"  class="form-control col-1"/>
        </div>
        <div class="col-3 row">
            <h5 class="col-7">
                Calendar statics
            </h5>
            <input type ="radio" height="10px" name="exportChoice" value="calendar"  class="form-control col-1"/>
        </div>
